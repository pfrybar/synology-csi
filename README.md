...
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------- |
| [v1.1.1](https://github.com/pfrybar/synology-csi/tree/release-v1.1.1) | [synology-csi:v1.1.1](https://hub.docker.com/r/synology/synology-csi) | 1.20+                 |
| [v1.1.0](https://github.com/pfrybar/synology-csi/tree/release-v1.1.0) | [synology-csi:v1.1.0](https://hub.docker.com/r/synology/synology-csi) | 1.20+                 |
| [v1.0.1](https://github.com/pfrybar/synology-csi/tree/release-v1.0.1) | [synology-csi:v1.0.1](https://hub.docker.com/r/synology/synology-csi) | 1.20+                 |
| [v1.0.0](https://github.com/pfrybar/synology-csi/tree/release-v1.0.0) | [synology-csi:v1.0.0](https://hub.docker.com/r/synology/synology-csi) | 1.19                  |
...
### Procedure
1. Clone the git repository. `git clone https://github.com/pfrybar/synology-csi.git`
